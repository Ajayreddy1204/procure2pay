...
def render_invoices():
    ...
    # If we have a search term, we'll show the detailed layout for that invoice (if exactly one match)
    # Otherwise show the search table.
    if search_term:
        ...
        if not inv_df.empty:
            ...
            # fall through to general list

    # ---------- General Invoice Search & Table ----------
