...
# Helper: Split invoice number for display
...
# Helper: Render single invoice card with clickable number

# ------------------------------------------------------------

def render_invoice_card(inv_num, inv_top, inv_bottom, amt, vendor, due, status_label, status_class, card_class, card_key):
...
<div class="invoice-card {card_class}">
    ...
    btn_col, info_col = st.columns([1, 1.3])
    ...
    with btn_col:
        ...
        with st.container():
            ...
            st.markdown('<div class="circle-invoice-btn">', unsafe_allow_html=True)
...
def render_needs_attention(rng_start, rng_end, vendor_where):
    ...
    # Determine status styling based on active tab
            ...
            if item_idx < len(page_df):
                ...
                with cols[col_idx]:
                    ...
                    render_invoice_card(
                        ...
                        card_key=f"inv_btn_{page}_{item_idx}_{inv_num}",
    ...
    with col_next:
        ...
        if st.button("Next â†’", disabled=(page >= total_pages - 1), use_container_width=True, key="na_next"):
