...
/* Ensure title is left-aligned and no overlap */
.title-section {
    text-align: left;
    margin-top: -0.5rem;
    margin-bottom: 0rem;
...
/* Make sure the left column doesn't overflow */
...
col_title, col_nav, col_logo = st.columns([1.2, 2.8, 1])  # Adjusted ratios for better spacing
